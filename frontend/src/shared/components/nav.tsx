export default function Nav() {
  return (
    <nav className="bg-gray-800 fixed h-full top-0 left-0 w-20 flex justify-center py-4 shadow-lg z-40">
      <div className="flex flex-col items-center justify-center space-y-12 h-full">
        ...
        >
          ...
          <span className="text-sm mt-1">Actuelles</span>
        </a>
        <a
        ...
        >
          ...
          <span className="text-sm mt-1">Horaires</span>
        </a>
        ...
        >
          ...
          <span className="text-sm mt-1">Demain</span>
        </a>
      </div>
    </nav>
  );
